...
import { cancelledOrdersTableData } from "../../constants/tableData";
  ...
  return (
    <>
      <div className="flex rounded-lg p-4">
        <h2 className="text-2xl font-semibold text-gray-700">Cancelled Orders</h2>
        ...
        <table className="min-w-full table-auto mt-6">
          <thead className=" bg-white border-gray-400 border-t-[2px] border-l-[2px] border-r-[2px] border-b-[2px]">
            <tr>
              ...
              <th className="px-4 py-4 text-left border-r border-gray-400">Menu</th>
              <th className="px-4 py-4 text-left border-r border-gray-400">Special Instruction</th>
              <th className="px-4 py-4 text-left border-r border-gray-400">Order Time</th>
              <th className="px-4 py-4 text-left border-r border-gray-400">Quantity</th>
              <th className="px-4 py-4 text-left border-r border-gray-400">Table No</th>
            </tr>
          </thead>
          <tbody className="border-[2px] border-opacity-50 border-[#969696]">
            {cancelledOrdersTableData?.map((order, index) => (
              <tr
                ...
                <td className="px-4 py-2 border-r border-gray-400">{order.specialInstructions}</td>
