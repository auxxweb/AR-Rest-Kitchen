...
import { completedOrdersTableData } from "../../constants/tableData";
      ...
      <table className="min-w-full table-auto mt-6">
        <thead  className="bg-white border-gray-400 border-t-[2px] border-l-[2px] border-r-[2px] border-b-[2px]">
          <tr>
            ...
            <th className="px-4 py-4 text-left">Paymet </th>
          </tr>
        </thead>
...
> {participant?.name}</u> */}
                ...
                <td
                  ...
                  className="px-4 py-2 border-r border-gray-400"
                >
                  {cData?.specialInstructions}
                </td>
                <td
                  // onClick={() => navigate(`/participants/${participant?._id}`)}
                  className="px-4 py-2 border-r border-gray-400"
                >
                  <div className="flex -space-x-2">{cData?.orderTime}</div>
                </td>
